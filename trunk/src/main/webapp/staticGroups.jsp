...
<%
	int pageId = Constants.STATICGROUPS_ID;
...
<tiles:insert template="/simpleTemplate.jsp">
	...
	<tiles:put name="subtitle"		content="<%=Constants.PAGES[Constants.GROUPS_ID][Constants.NAVNAME]%>" direct="true" />
	<tiles:put name="subtitlelink"	content="<%=Constants.PAGES[Constants.GROUPS_ID][Constants.ACTION]%>" direct="true" />
	<tiles:put name="subsubtitle"	content="<%=Constants.PAGES[Constants.STATICGROUPS_ID][Constants.NAVNAME]%>" direct="true" />
