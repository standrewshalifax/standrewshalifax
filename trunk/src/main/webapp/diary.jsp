...
<tiles:insert template="/simpleTemplate.jsp">
	...
	<tiles:put name="subtitle"		content="<%=Constants.PAGES[Constants.EVENTS_ID][Constants.NAVNAME]%>" direct="true" />
	<tiles:put name="subtitlelink"	content="<%=Constants.PAGES[Constants.EVENTS_ID][Constants.ACTION]%>" direct="true" />
