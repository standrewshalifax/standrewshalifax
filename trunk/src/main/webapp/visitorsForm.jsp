...
<%
	int pageId = Constants.VISITORSFORM_ID;
...
<tiles:insert template="/simpleTemplate.jsp">
	...
	<tiles:put name="subtitle"		content="<%=Constants.PAGES[Constants.CONTACT_ID][Constants.NAVNAME]%>" direct="true" />
	<tiles:put name="subtitlelink"	content="<%=Constants.PAGES[Constants.CONTACT_ID][Constants.ACTION]%>" direct="true" />
	<tiles:put name="subsubtitle"	content="<%=Constants.PAGES[pageId][Constants.NAVNAME]%>" direct="true" />
